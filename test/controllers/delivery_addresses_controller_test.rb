...
class DeliveryAddressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create delivery_address" do
    assert_difference("DeliveryAddress.count") do
      post delivery_addresses_url, params: { delivery_address: { address: @delivery_address.address, user_id: @delivery_address.user_id } }
    end
  ...
  test "should update delivery_address" do
    patch delivery_address_url(@delivery_address), params: { delivery_address: { address: @delivery_address.address, user_id: @delivery_address.user_id } }
